...
@Service("DxxzspTerminationChangeChaThreeService")
public class DxxzspTerminationChangeChaThreeServiceImpl implements DxxzspTerminationChangeChaThreeService{
	@Resource
	...
	public Map<String, Object> getRow(String id, String flowrunid)throws AppException {
		...
		List<Map<String,Object>> list_SafePlan =  commonMapper.findManyData("select * from DXXZSP_SAFE_PLAN where itemid = '"+itemid+"'");
