...
@Service("DxxzspTerminationChangeChaFiveService")
public class DxxzspTerminationChangeChaFiveServiceImpl implements DxxzspTerminationChangeChaFiveService{
	@Resource
	...
	public Map<String, Object> getRow(String id, String flowrunid)throws AppException {
		...
		List<Map<String,Object>> list_InfoproChanged =  commonMapper.findManyData("select * from DXXZSP_INFOPRO_CHANGED where itemid = '"+itemid+"'");
