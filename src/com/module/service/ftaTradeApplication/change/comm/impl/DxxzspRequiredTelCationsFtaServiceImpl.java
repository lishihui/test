...
@Service("DxxzspRequiredTelCationsFtaService")
public class DxxzspRequiredTelCationsFtaServiceImpl implements DxxzspRequiredTelCationsFtaService{
	@Resource
	private CommonMapper commonMapper;
	@Resource
	private DxxzspZmqKqyxksqggbMapper dxxzspZmqKqyxksqggbMapper;
	@Resource
	private ItemUserApplyService itemuApplyService;
	@Override
	public Map<String, Object> getRow(String id, String flowrunid)throws AppException {
		String itemid=itemuApplyService.getProcessId(id);
