...
@Service("DxxzspCompanyPersonnelStatementFtaService")
public class DxxzspCompanyPersonnelStatementFtaServiceImpl implements DxxzspCompanyPersonnelStatementFtaService {
	@Resource
