...
@Service("DxxzspDataProcessingAndTransactionService")
public class DxxzspDataProcessingAndTransactionServiceImpl  implements DxxzspDataProcessingAndTransactionService {
	@Resource
