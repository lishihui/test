...
@Service("DxxzspCommunicationProvidedByResaleProService")
public class DxxzspCommunicationProvidedByResaleProServiceImpl implements DxxzspCommunicationProvidedByResaleProService {
	@Resource
