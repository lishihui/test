...
@Service("DxxzspNetworkHostingServiceTwoService")
public class DxxzspNetworkHostingServiceTwoProServiceImpl  implements DxxzspNetworkHostingServiceTwoProService {
	@Resource
