...
@Service("DxxzspValueAddTelecomLicenseProService")
public class DxxzspValueAddTelecomLicenseProServiceImpl implements DxxzspValueAddTelecomLicenseProService{
	@Resource
	...
	public Map<String, Object> getRow(String id, String flowrunid)throws AppException {
		...
		Map<String,Object> list_ValueAddTelecomLicensePro =  commonMapper.findOneData("select * from DXXZSP_KQYXKSQGGB where itemid = '"+itemid+"'");
		if(list_ValueAddTelecomLicensePro != null){
			String ywid = (String) list_ValueAddTelecomLicensePro.get("ID");
			String parentid = (String) list_ValueAddTelecomLicensePro.get("ID");
