...
@Service("DxxzspLetterOfOperatingTelecomProService")
public class DxxzspLetterOfOperatingTelecomProServiceImpl implements DxxzspLetterOfOperatingTelecomProService {
	@Resource
	...
	public Map<String, Object> getRow(String id, String flowrunid)throws AppException {
		...
		Map<String,Object> list_LetterOfOperatingTelecomPro =  commonMapper.findOneData("select * from DXXZSP_KQYXKSQGGB where itemid = '"+itemid+"'");
		if(list_LetterOfOperatingTelecomPro != null){
			String ywid = (String) list_LetterOfOperatingTelecomPro.get("ID");
			String parentid = (String) list_LetterOfOperatingTelecomPro.get("ID");
