...
@Controller
@RequestMapping("/DxxzspTerminationRealmChangeChaFiv")
public class DxxzspTerminationRealmChangeChaFivController {
	@Resource
	private DxxzspTerminationRealmChangeChaService DxxzspTerminationRealmChangeChaService;
	
	//页面跳转
	@RequestMapping("/toDxxzspTerminationRealmChangeChaFiv")
	public ModelAndView toDxxzspTerminationRealmChangeCha(String id,String flowrunid) throws AppException {
		ModelAndView mv = new ModelAndView("domainRegistration/change/change/DxxzspTerminationRealmChangeChaFiv");
		//业务查询
