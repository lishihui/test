...
//1、固定网国内数据传送业务
@Controller
@RequestMapping("/DxxzspAuditTaskCommonKuadiqu")
public class DxxzspAuditTaskCommonKuadiquController {
	@Resource
	private DxxzspAuditTaskCommonService dxxzspAuditTaskCommonService;
	
	//页面跳转
	@RequestMapping("/toDxxzspAuditTaskCommonKuadiqu")
	public ModelAndView toDxxzspAuditTaskCommonKuadiqu(HttpServletRequest request, String param, String pageNo,String pageSize) throws Exception {
		ModelAndView mv = new ModelAndView("domainRegistration/change/comm/DxxzspAuditTaskCommonKuadiqu");
		...
		Map<String,Object> data = (Map<String, Object>) dxxzspAuditTaskCommonService.getList(obj_record, "kuadiqu", currentPage, currentPageSize);
		//查询记录总数
		
		int count_size = dxxzspAuditTaskCommonService.getRowCount(obj_record, "kuadiqu");
