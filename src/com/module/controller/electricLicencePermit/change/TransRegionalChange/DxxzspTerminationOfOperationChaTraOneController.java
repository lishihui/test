...
@Controller
@RequestMapping("/DxxzspTerminationOfOperationChaTraOne")
public class DxxzspTerminationOfOperationChaTraOneController {
	@Resource
	private DxxzspTerminationOfOperationChaTraService dxxzspTerminationOfOperationChaTraService;
	
	//页面跳转
	@RequestMapping("/toDxxzspTerminationOfOperationChaTraOne")
	public ModelAndView toDxxzspTerminationOfOperationChaTraOne(String id,String flowrunid) throws AppException {
		ModelAndView mv = new ModelAndView("electricLicencePermit/change/TransRegionalChange/DxxzspTerminationOfOperationChaTraOne");
		//业务查询
