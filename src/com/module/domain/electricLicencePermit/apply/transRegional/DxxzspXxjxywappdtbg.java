...
public class DxxzspXxjxywappdtbg {
    private String id;
    ...
    private String appfzd;

    private String apptgdw;
    ...
    public String getAppfzd() {
        return appfzd;
    }

    public void setAppfzd(String appfzd) {
        this.appfzd = appfzd == null ? null : appfzd.trim();
    }

    public String getApptgdw() {
        return apptgdw;
    }

    public void setApptgdw(String apptgdw) {
        this.apptgdw = apptgdw == null ? null : apptgdw.trim();
    }
