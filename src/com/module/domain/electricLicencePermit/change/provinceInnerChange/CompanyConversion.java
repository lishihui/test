...
public class CompanyConversion {
	...
	public void setLicenseNumber(String licenseNumber) {
		this.licenseNumber = licenseNumber == null ? null : licenseNumber
				.trim();
	}
	...
	public void setChangedCompanyName(String changedCompanyName) {
		this.changedCompanyName = changedCompanyName == null ? null
				: changedCompanyName.trim();
	}
	...
	public void setNameChangeProof(String nameChangeProof) {
		this.nameChangeProof = nameChangeProof == null ? null : nameChangeProof
				.trim();
	}
