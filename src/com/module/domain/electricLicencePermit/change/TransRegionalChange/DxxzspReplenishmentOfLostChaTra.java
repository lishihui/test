...
public class DxxzspReplenishmentOfLostChaTra {
	 private String id;
	    ...
	    public String getLossDecla() {
	        return lossDecla;
	    }

	    public void setLossDecla(String lossDecla) {
	        this.lossDecla = lossDecla == null ? null : lossDecla.trim();
	    }
