...
public class DxxzspDomainAgreementRealname {
    private String id;
    ...
    public String getSmhyqt() {
        return smhyqt;
    }

    public void setSmhyqt(String smhyqt) {
        this.smhyqt = smhyqt == null ? null : smhyqt.trim();
    }
