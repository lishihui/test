...
public class DxxzspDomainAgreementOffice {
    private String id;
    ...
    public String getWtjgother() {
        return wtjgother;
    }

    public void setWtjgother(String wtjgother) {
        this.wtjgother = wtjgother == null ? null : wtjgother.trim();
    }
