...
public class DxxzspShareholderRealmChange {
    private String id;
    ...
    public String getAfterStructure() {
        return afterStructure;
    }

    public void setAfterStructure(String afterStructure) {
        this.afterStructure = afterStructure == null ? null : afterStructure.trim();
    }
