...
public class DxxzspOfficeAddress {
    private String id;
    ...
    public void setBeforeAddress(String beforeAddress) {
        this.beforeAddress = beforeAddress == null ? null : beforeAddress.trim();
    }
    ...
    public void setAfterAddress(String afterAddress) {
        this.afterAddress = afterAddress == null ? null : afterAddress.trim();
    }
