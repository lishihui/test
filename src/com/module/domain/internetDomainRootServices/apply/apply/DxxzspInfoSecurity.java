...
public class DxxzspInfoSecurity {
    private String id;
    ...
    public String getSafetyLinkman() {
        return safetyLinkman;
    }

    public void setSafetyLinkman(String safetyLinkman) {
        this.safetyLinkman = safetyLinkman == null ? null : safetyLinkman.trim();
    }
