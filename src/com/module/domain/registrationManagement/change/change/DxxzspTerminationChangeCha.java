...
public class DxxzspTerminationChangeCha {
    private String id;
    ...
    private String approvedTopLevel;
    ...
    public String getApprovedTopLevel() {
        return approvedTopLevel;
    }

    public void setApprovedTopLevel(String approvedTopLevel) {
        this.approvedTopLevel = approvedTopLevel == null ? null : approvedTopLevel.trim();
    }
    ...
    public String getContactFixedTele() {
        return contactFixedTele;
    }

    public void setContactFixedTele(String contactFixedTele) {
        this.contactFixedTele = contactFixedTele == null ? null : contactFixedTele.trim();
    }
